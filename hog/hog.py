...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    right_o, right_t = 0, 0
    right_o = player_score % 10
    right_t = (opponent_score // 10) % 10
    res = (right_o - right_t) * 3
    if res < 0: return -res
    elif res == 0: return 1
    else: return res
    # END PROBLEM 2

#给r次数, 玩家分数, 对手分数, 骰方法后,得到的分数
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    """
    # BEGIN PROBLEM 4
    now_score = take_turn(num_rolls, player_score, opponent_score, dice)
    return sus_points(now_score + player_score)
    # END PROBLEM 4
...
#它接受一个骰子数量 n 并返回一个始终投掷 n 骰子的策略函数。因此， always_roll(5) 将等同于 always_roll_5 
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def get_nub_rolls(s0, s1):
       return n
    return get_nub_rolls
    # END PROBLEM 6
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    roll_zero_score = boar_brawl(score, opponent_score)
    if roll_zero_score >= threshold:
        num_rolls = 0
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    if roll_zero_score - score >= threshold:
        return 0
    return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # 2. 对比 Picky Boar 和平均收益
    boar_score = sus_update(0, score, opponent_score)
    num_rolls = 6
    threshold = sus_update(num_rolls, score, opponent_score) - score
